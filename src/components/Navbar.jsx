...
function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className='sticky top-0 w-full px-20 py-6 font-["Neue Montreal"] flex items-center justify-between z-[999] backdrop-blur-lg'>
      ...
      <div className='links flex gap-5'>
        {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map((link, index) => (
          <a key={index} className={`text-lg text-white capitalize font-light ${index === 4 && "ml-30"}`}>
            {link}
          </a>
        ))}
      </div>
