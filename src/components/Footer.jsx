...
function Footer() {
  return (
    <div className="w-full h-screen bg-zin-900 flex">
      <div className='W-1/2 font-["Founders_Grotesk"] text-white mx-auto pt-20'>
        <div className='h-full flex flex-col justify-between'>
          <div className='heading'>
            <h1 className='font-semibold text-[10vh] leading-none uppercase'>Eye-</h1>
            <h1 className='font-semibold text-[10vh] leading-none uppercase'>Opening</h1>
          </div>
          <svg className='mb-10' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className='w-1/2  text-white mx-auto pt-20'>
        <h1 className='font-["Founders_Grotesk"] font-light text-[8vh] leading-none uppercase'>Presentations</h1>
        <div className="text-[3vh] font-['Neue_Montreal'] mt-10">
          <h1 className='mb-3'>S:</h1>
          {["Instagram", "Linkedin", "Twitter", "Youtube"].map((platform, index) => {
            return(
              <a key={index} href={`https://${platform}.com`} className="block text-[2vh]">
                {platform}
              </a>
            )
          })}
